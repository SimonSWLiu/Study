...
public class S3Sample {
    ...
    private static String keyName = "resources/dish1.jpg";
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            File file =
                    new File(System.getProperty("user.dir") + File.separator + "OneMenu"
                            + File.separator + "demo" + File.separator + "test.jpg");
