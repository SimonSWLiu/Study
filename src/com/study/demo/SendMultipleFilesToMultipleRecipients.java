...
public class SendMultipleFilesToMultipleRecipients {
    ...
    static String FAX_NUMBERS = "18559357319;18559357319;18559357319"; // semicolon-delimited
                                                                       // list of destination
                                                                       // fax
                                                                       // numbers
    ...
    static String[] FILES = new String[] {FILE_PATH + "test.pdf", FILE_PATH + "test.html"}; // List
                                                                                            // of
                                                                                            // files
                                                                                            // to
    // fax
