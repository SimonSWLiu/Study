...
public class Proxy {
	public static Object newProxyInstance(Class interfaces, InvocationHandler h)
		...
		for (Method method : methods) {
			methodStr.append("    public " + method.getReturnType() + " "
					+ method.getName() + "() {" + tr + "        try {" + tr
					+ "            java.lang.reflect.Method md = "
					+ interfaces.getName() + "." + "class.getMethod(\""
					+ method.getName() + "\");" + tr
					+ "            h.invoke(this,md);" + tr
		...
		// 拼接代理类
		String src = "package com.test;" + tr + "import com.test.Moveable;"
				+ tr + "public class TimeProxy implements "
				+ interfaces.getName() + " {" + tr
		...
		String fileName = System.getProperty("user.dir")
				+ "/src/com/study/designpattern/dynamicproxy/TimeProxy.java";
		...
		Class c = ClassLoader.getSystemClassLoader().loadClass(
				"com.study.designpattern.dynamicproxy.TimeProxy");
